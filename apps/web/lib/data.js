...
const HUNT_SCORE_CACHE_VERSION = 5;
...
const CROSS_STORE_BACKTEST_WINDOW_BUFFER_DAYS = 35;
  ...
  for (const row of rows) {
    ...
    for (const [slotNumber, record] of Object.entries(recordsBySlot)) {
      expandedRows.push({
        ...
        setting_estimate_grape_average: record?.setting_estimate_grape_average ?? null,
        setting_estimate_grape_status: String(record?.setting_estimate_grape_status ?? "").trim() || null,
        setting_estimate_grape_source: String(record?.setting_estimate_grape_source ?? "").trim() || null,
        setting_estimate_grape_version: record?.setting_estimate_grape_version ?? null,
        ...
        estimated_grape_count: record?.estimated_grape_count ?? null,
        estimated_grape_denominator: record?.estimated_grape_denominator ?? null,
        estimated_grape_probability: record?.estimated_grape_probability ?? null,
        estimated_grape_status: String(record?.estimated_grape_status ?? "").trim() || null,
        estimated_grape_source: String(record?.estimated_grape_source ?? "").trim() || null,
        estimated_grape_version: record?.estimated_grape_version ?? null,
  ...
  for (const row of sortedRows) {
    ...
    for (const slotNumber of Object.keys(sourceRecords).sort(compareSlotNumbers)) {
      ...
      const record = withCanonicalMachineName({
        ...
        setting_estimate_grape_average: sourceRecord.setting_estimate_grape_average ?? null,
        setting_estimate_grape_status: String(sourceRecord.setting_estimate_grape_status ?? "").trim() || null,
        setting_estimate_grape_source: String(sourceRecord.setting_estimate_grape_source ?? "").trim() || null,
        setting_estimate_grape_version: sourceRecord.setting_estimate_grape_version ?? null,
        ...
        estimated_grape_count: sourceRecord.estimated_grape_count ?? null,
        estimated_grape_denominator: sourceRecord.estimated_grape_denominator ?? null,
        estimated_grape_probability: sourceRecord.estimated_grape_probability ?? null,
        estimated_grape_status: String(sourceRecord.estimated_grape_status ?? "").trim() || null,
        estimated_grape_source: String(sourceRecord.estimated_grape_source ?? "").trim() || null,
        estimated_grape_version: sourceRecord.estimated_grape_version ?? null,
...
function readStaticStoreRecords(staticStore, dateRange = null) {
  const normalizedRows = (Array.isArray(staticStore?.records) ? staticStore.records : [])
    .map((record) => ({
      ...
      setting_estimate_grape_average: readNumber(record.setting_estimate_grape_average),
      setting_estimate_grape_status: String(record.setting_estimate_grape_status ?? "").trim() || null,
      setting_estimate_grape_source: String(record.setting_estimate_grape_source ?? "").trim() || null,
      setting_estimate_grape_version: readNumber(record.setting_estimate_grape_version),
      ...
      estimated_grape_count: readNumber(record.estimated_grape_count),
      estimated_grape_denominator: readNumber(record.estimated_grape_denominator),
      estimated_grape_probability: readNumber(record.estimated_grape_probability),
      estimated_grape_status: String(record.estimated_grape_status ?? "").trim() || null,
      estimated_grape_source: String(record.estimated_grape_source ?? "").trim() || null,
      estimated_grape_version: readNumber(record.estimated_grape_version),
      combined_ratio_text: record.combined_ratio_text ?? null,
      bb_ratio_text: record.bb_ratio_text ?? null,
      rb_ratio_text: record.rb_ratio_text ?? null,
