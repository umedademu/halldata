...
function resolveRankingDateSpecificSetting(definition, setting, options = {}) {
  if (
    ...
    !["neo-aim", "funky", "my"].includes(definition?.machineKey)
  ) {
    return setting;
  }
